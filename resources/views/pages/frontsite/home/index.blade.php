        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-4">
                        <div class="btn-xlg-square bg-primary rounded-circle me-3">
                            <i class="fa-solid fa-screwdriver-wrench text-white fa-2xl"></i>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="d-flex align-items-center mb-4">
                        <div class="btn-xlg-square bg-primary rounded-circle me-3">
                            <i class="fa-solid fa-file-invoice text-white fa-2xl"></i>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="d-flex align-items-center mb-4">
                        <div class="btn-xlg-square bg-primary rounded-circle me-3">
                            <i class="fa-solid fa-gear text-white fa-2xl"></i>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="d-flex align-items-center mb-4">
                        <div class="btn-xlg-square bg-primary rounded-circle me-3">
                            <i class="fa-solid fa-calendar-days text-white fa-2xl"></i>
                        </div>
            ...
            <div class="row-client no-gutters clients-wrap  wow fadeInUp">
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-1.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-2.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-3.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-4.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-5.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
                        <img src="assets/frontsite/img/clients/client-6.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6">
                    <div class="client-logo">
